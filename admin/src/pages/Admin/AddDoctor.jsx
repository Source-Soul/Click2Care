            ...
            <div className="bg-white px-8 py-8 border rounded w-full max-w-4xl max-h-[80vh] overflow-y-scroll">
                ...
                <div>
                    <p className='mt-4 mb-2'>
                        About Doctor</p>
                    <textarea
                         className="w-full h-32 px-4 pt-2 border rounded-lg resize-none"
                        placeholder='write about doctor' required />
                </div>

                <button className="bg-green-700 hover:bg-primary transition duration-300 px-10 py-3 mt-4 text-white font-medium rounded-full shadow-md">
                    Add Doctor
                </button>
